...
def create_app():
    ...
    bcrypt.init_app(app)
    CORS(app, supports_credentials=True, resources={r"/*": {"origins": ["http://192.168.191.100:3000", "http://172.18.0.3:3000","http://localhost:3000","http://10.80.3.10:3000","http://10.80.42.66:3000"]}})
